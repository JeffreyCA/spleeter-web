# Generated by Django 3.0.6 on 2020-05-31 01:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_file', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='api.SourceFile')),
            ],
        ),
        migrations.AddField(
            model_name='sourcefile',
            name='youtube_fetch_task',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.YTAudioDownloadTask'),
        ),
        migrations.CreateModel(
            name='ProcessedTrack',
            fields=[
